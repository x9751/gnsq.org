...
export default function NewsArticle({
	...
	return (
		<article className="relative m-2 w-full rounded group/article border border-transparent bg-green-900 flex flex-col hover:bg-green-950 hover:border-green-700 transition-colors">
			...
			>
				<div className="p-4 w-full max-w-[95%] absolute top-1/2 left-1/2 bg-slate-50 rounded md:max-w-md text-slate-900 -translate-x-1/2 -translate-y-1/2">
