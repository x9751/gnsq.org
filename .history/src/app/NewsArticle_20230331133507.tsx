			...
			>
				<div className="p-4 absolute top-1/2 left-1/2 bg-slate-50 rounded max-w-md text-slate-900 -translate-x-1/2 -translate-y-1/2">
					<button
						...
						className="absolute top-0 right-0 text-white translate-x-1/2 -translate-y-1/2 bg-black bg-opacity-20 hover:bg-opacity-100 rounded"
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							fill="none"
					...
					<p className="text-basis mt-2">{body}</p>
				</div>
			</div>
		</article>
	);
