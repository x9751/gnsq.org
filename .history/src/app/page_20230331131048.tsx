...
function NewsArticle({
	...
	return (
		<article className="relative p-2 w-full rounded group/article border border-transparent bg-green-900 flex flex-col group-hover:bg-green-950 transition-colors">
