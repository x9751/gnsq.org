...
function NewsArticle({
	...
	return (
		<article className="relative p-2 w-full rounded group/article border border-transparent bg-green-900 flex flex-col hover:bg-green-950 hover:border-green-800 transition-colors">
			<h3 className="text-sm font-semibold text-white max-w-[90%]">
				{title}
			</h3>
			<p className="text-slate-50 mt-2 truncate">{body}</p>
			<button className="text-white text-xs ml-auto mt-2 p-1">
				View More
			</button>
		</article>
	);
