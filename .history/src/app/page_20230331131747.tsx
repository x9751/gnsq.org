...
function NewsArticle({
	...
	return (
		<article className="relative p-2 w-full rounded group/article border border-transparent bg-green-900 flex flex-col hover:bg-green-950 hover:border-green-700 transition-colors">
			...
			<button className="text-white text-xs ml-auto mt-2 p-1 hover:bg-green-500 rounded transition-colors flex items-center">
				View More
				<div className="relative overflow-hidden inline-block ml-1">
					<svg
						...
						viewBox="0 0 20 20"
						fill="currentColor"
						className="w-4 h-4 -translate-x-full group-hover:translate-x-px"
					>
						<path
							fillRule="evenodd"
